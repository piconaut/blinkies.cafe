const styleProps = {
    '0022-iheart':        {name:"blinkies so much !!!", bday:20220227, frames:4, colour:["#ffffff","#ffffff","#ffffff", "#ffffff"], shadow:["#888888","#888888","#888888","#888888"], font: "monaco", fontsize:16, x:-20, y:-1, sourceName:"y2k.neocities.org", sourceURL:"https://y2k.neocities.org"},
    ...
    '0020-blinkiesCafe':  {name:"blinkies.cafe", bday:20220222, frames:2, delay:10, colour:["#000000","#000000"], shadow:["#666666","#666666"], font: "monaco", fontsize:16, x:0, y:0, sourceName:"me :)"},
